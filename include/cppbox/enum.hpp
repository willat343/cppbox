...
#define CREATE_SMART_ENUM_IMPL_CONSTRUCTOR_WITH_COMMA(SmartEnum, x) SmartEnum(x),
/**
 * @brief This macro creates a class which acts as an enum, except it is constructable from and convertible to a string.
    ...
    public:                                                                                                      \
        ...
        static constexpr std::array<SmartEnum, SmartEnum::count> values() {                                      \
            return std::to_array<SmartEnum>(                                                                     \
                    {FOR_EACH_I(CREATE_SMART_ENUM_IMPL_CONSTRUCTOR_WITH_COMMA, SmartEnum, __VA_ARGS__)});        \
        }                                                                                                        \
                                                                                                                 \
        constexpr SmartEnum() {};                                                                                \
                                                                                                                 \
